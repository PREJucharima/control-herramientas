...
const ChileFlagIcon = (props) => (
  <SvgIcon viewBox="0 0 36 36" {...props}>
    <path
      fill="#1F429B"
      d="M13 5H4a4 4 0 0 0-4 4v9h13V5zm-4.663 9.292l-1.882-1.367-1.882 1.367.719-2.212-1.882-1.368h2.326L6.455 8.5l.719 2.212H9.5L7.618 12.08l.719 2.212z"
    />
